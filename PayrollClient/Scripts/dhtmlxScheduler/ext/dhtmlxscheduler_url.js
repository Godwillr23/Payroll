...
e.attachEvent("onBeforeViewChange",function(o,d,l,_){if(a){a=!1;var s=e._get_url_nav();if(s.event)try{if(e.getEvent(s.event))return setTimeout(function(){t(s.event)}),!1;var c=e.attachEvent("onXLE",function(){setTimeout(function(){t(s.event)}),e.detachEvent(c)})}catch(e){}if(s.date||s.mode){try{this.setCurrentView(s.date?n(s.date):null,s.mode||null)}catch(e){this.setCurrentView(s.date?n(s.date):null,l)}return!1}}var u=["date="+i(_||d),"mode="+(l||o)];r&&u.push("event="+r);var h="#"+u.join(",")
